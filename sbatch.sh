...
#SBATCH --job-name ml_1			### name of the job
...
#SBATCH --mail-user=nunu@post.bgu.ac.il	### user's email for sending job status messages
#SBATCH --mail-type=ALL			### conditions for sending the email. ALL,BEGIN,END,FAIL, REQUEU, NONE
#SBATCH --mem=64G				### ammount of RAM memory, allocating more than 60G requires IT team's permission
#SBATCH --array=0           ### define job array with indices
...
source activate spatial-transcriptomics				### activate a conda environment, replace my_env with your conda environment
cd /sise/assafzar-group/assafzar/kobe/ML_Assigment_1			### change the working directory to the project folder
